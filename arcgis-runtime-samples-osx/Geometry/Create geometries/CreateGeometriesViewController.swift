...
class CreateGeometriesViewController: NSViewController {
    ...
    override func viewDidLoad() {
        ...
        let markerSymbol = AGSSimpleMarkerSymbol(style: .Triangle, color: NSColor.blueColor(), size: 14)
        let lineSymbol = AGSSimpleLineSymbol(style: .Solid, color: NSColor.blueColor(), width: 3)
